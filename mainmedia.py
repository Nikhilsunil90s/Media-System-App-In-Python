...
'''class secondmedia(QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui.pushButton.clicked.connect(self.documents)
'''
...
class classmusic(QMainWindow):
    def load(self):
        file = QFileDialog.getOpenFileName(self,"Select Audio:")
    ...
    def next(self):
        import os 
        y = self.ui.listWidget.currentItem().text()#selects current selected iem's text
        itemlist = []
...
class imageclass(QMainWindow):
    ...
    def loadimages(self):
        #pass #put code here
        file = QFileDialog.getOpenFileName(self,"Select and Load Image:")
        #print(file)
        self.ui.listWidget.addItem(file[0])
